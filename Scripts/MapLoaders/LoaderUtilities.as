...
TileType server_onTileHit(CMap @map, f32 damage, u32 index, TileType oldTileType)
{
	if (map.getTile(index).type > 255)
	{
		switch (oldTileType)
		{
			...
			{
				return CMap::tile_grass_fullbackground1_d1;
			}
			case CMap::tile_grass_fullbackground1_d1:
			{
				return CMap::tile_grass_fullbackground1_d2;
			}
			case CMap::tile_grass_fullbackground1_d2:
			{
				return CMap::tile_grass_fullbackground1_d3;
			}
			...
			{
				return CMap::tile_grass_fullbackground2_d1;
			}
			case CMap::tile_grass_fullbackground2_d1:
			{
				return CMap::tile_grass_fullbackground2_d2;
			}
			case CMap::tile_grass_fullbackground2_d2:
			{
				return CMap::tile_grass_fullbackground2_d3;
			}
			...
			{
				return CMap::tile_grass_cornerbackground_d1;
			}
			case CMap::tile_grass_cornerbackground_d1:
			{
				return CMap::tile_grass_cornerbackground_d2;
			}
			case CMap::tile_grass_cornerbackground_d2:
			{
				return CMap::tile_grass_cornerbackground_d3;
			}
			...
			case CMap::tile_goldenbrick:
			{
				...
				return CMap::tile_goldenbrick_d0;
			}
			...
			{
				return CMap::tile_heapsbloodgrassground_d0;
			}
	...
	if (map.getTile(index).type > 255) // custom solids
	{
		...
		switch (tile_new)
		{
			...
			case CMap::tile_goldenbrick:
			{
				...
				map.AddTileFlag(index, Tile::SOLID | Tile::COLLISION);
				if (getNet().isClient())
					Sound::Play("build_wall.ogg", map.getTileWorldPosition(index), 1.0f, 0.6f);
				break;
			}
			case CMap::tile_goldenbrick_d0:
			case CMap::tile_goldenbrick_d1:
			...
			case CMap::tile_ironbrick:
			{
				...
				map.AddTileFlag(index, Tile::SOLID | Tile::COLLISION);
				if (getNet().isClient())
					Sound::Play("build_wall2.ogg", map.getTileWorldPosition(index), 1.0f, 1.0f);
				break;
			}
			case CMap::tile_ironbrick_d0:
			case CMap::tile_ironbrick_d1:
...
void OnCopperTileHit(CMap @map, u32 index)
{
	map.AddTileFlag(index, Tile::SOLID | Tile::COLLISION);
	map.RemoveTileFlag(index, Tile::LIGHT_PASSES | Tile::LIGHT_SOURCE | Tile::BACKGROUND);
...
void OnCopperTileDestroyed(CMap @map, u32 index)
{
	if (getNet().isClient())
	{
		Vec2f pos = map.getTileWorldPosition(index);
