...
class PNGLoader
{
	...
	void handlePixel(const SColor&in pixel, int offset)
	{
		...
		switch (pixel.color)
		{
			...
			case map_colors::princess:
				autotile(offset);
				spawnBlob(map, "princess", offset, 6);
				break;
			case map_colors::necromancer:
				autotile(offset);
				spawnBlob(map, "necromancer", offset, 3);
				break;
			case map_colors::necromancer_teleport:
				autotile(offset);
			...
			case map_colors::red_main_spawn:
				...
				break;
			case map_colors::green_main_spawn:
				autotile(offset);
				spawnHall(map, offset, 2);
				break;
			case map_colors::purple_main_spawn:
				autotile(offset);
				spawnHall(map, offset, 3);
				break;
			case map_colors::orange_main_spawn:
				autotile(offset);
				spawnHall(map, offset, 4);
				break;
			case map_colors::aqua_main_spawn:
				autotile(offset);
				spawnHall(map, offset, 5);
				break;
			case map_colors::teal_main_spawn:
				autotile(offset);
				spawnHall(map, offset, 6);
				break;
			case map_colors::gray_main_spawn:
				autotile(offset);
				spawnHall(map, offset, 7);
				break;

			// Red Barrier
			case map_colors::redbarrier:
				autotile(offset);
				AddMarker(map, offset, "red barrier");
				break;

			// Normal spawns
			case map_colors::blue_spawn:
				autotile(offset);
			...
			case map_colors::red_spawn:
				...
				break;
			case map_colors::purple_spawn:
				autotile(offset);
				AddMarker(map, offset, "purple spawn");
				break;
			case map_colors::aqua_spawn:
				autotile(offset);
				AddMarker(map, offset, "aqua spawn");
				break;
			case map_colors::teal_spawn:
				autotile(offset);
				AddMarker(map, offset, "teal spawn");
				break;
			case map_colors::gray_spawn:
				autotile(offset);
				AddMarker(map, offset, "gray spawn");
				break;

			// Workshops
			case map_colors::knight_shop:
				autotile(offset);
				spawnBlob(map, "knightshop", offset);
				break;
			case map_colors::builder_shop:
				autotile(offset);
				spawnBlob(map, "buildershop", offset);
				break;
			case map_colors::archer_shop:
				autotile(offset);
				spawnBlob(map, "archershop", offset);
				break;
			case map_colors::boat_shop:
				autotile(offset);
				spawnBlob(map, "boatshop", offset);
				break;
			case map_colors::vehicle_shop:
				autotile(offset);
				spawnBlob(map, "vehicleshop", offset);
				break;
			case map_colors::quarters:
				autotile(offset);
				spawnBlob(map, "quarters", offset);
				break;
			case map_colors::storage_noteam:
				autotile(offset);
				spawnBlob(map, "storage", offset);
				break;
			case map_colors::barracks_noteam:
				autotile(offset);
				spawnBlob(map, "barracks", offset);
				break;
			case map_colors::factory_noteam:
				autotile(offset);
				spawnBlob(map, "factory", offset);
				break;
			case map_colors::tunnel_blue:
				autotile(offset);
				spawnBlob(map, "tunnel", offset, 0);
				break;
			case map_colors::tunnel_red:
				autotile(offset);
				spawnBlob(map, "tunnel", offset, 1);
				break;
			case map_colors::tunnel_noteam:
				autotile(offset);
				spawnBlob(map, "tunnel", offset);
				break;
			case map_colors::kitchen:
				autotile(offset);
				spawnBlob(map, "kitchen", offset);
				break;
			case map_colors::nursery:
				autotile(offset);
				spawnBlob(map, "nursery", offset);
				break;
			case map_colors::research:
				autotile(offset);
				spawnBlob(map, "research", offset);
				break;

			case map_colors::workbench:
				autotile(offset);
				spawnBlob(map, "workbench", offset, 255, true);
				break;
			case map_colors::campfire:
				autotile(offset);
				spawnBlob(map, "fireplace", offset, 255);
				break;
			case map_colors::saw:
				autotile(offset);
				spawnBlob(map, "saw", offset);
				break;
			...
			case map_colors::tree + (3 << 4):
				...
				break;
			case map_colors::bush:
				autotile(offset);
				offsets[bush_offset].push_back(offset);
				break;
			case map_colors::grain:
				autotile(offset);
				offsets[grain_offset].push_back(offset);
				break;
			case map_colors::flowers:
				autotile(offset);
				spawnBlob(map, "flowers", offset);
				break;
			case map_colors::log:
				autotile(offset);
				spawnBlob(map, "log", offset);
				break;

			// Fauna
			case map_colors::shark:
				autotile(offset);
				spawnBlob(map, "shark", offset);
				break;
			case map_colors::fish:
				autotile(offset);
				spawnBlob(map, "fishy", offset).set_u8("age", (offset * 997) % 4);
				break;
			case map_colors::bison:
				autotile(offset);
				spawnBlob(map, "bison", offset);
				break;
			case map_colors::chicken:
				autotile(offset);
				spawnBlob(map, "chicken", offset, 255, false, Vec2f(0, -8));
				break;
			...
			// Platforms
			case map_colors::platform_up:
				autotile(offset);
				spawnBlob(map, "wooden_platform", offset, 255, true);
				break;
			case map_colors::platform_right:
				autotile(offset);
				spawnBlob(map, "wooden_platform", offset, 255, true, Vec2f_zero, 90);
				break;
			case map_colors::platform_down:
				autotile(offset);
				spawnBlob(map, "wooden_platform", offset, 255, true, Vec2f_zero, 180);
				break;
			case map_colors::platform_left:
				autotile(offset);
				spawnBlob(map, "wooden_platform", offset, 255, true, Vec2f_zero, -90);
				break;

			// Doors
			case map_colors::wooden_door_h_blue:
				autotile(offset);
				spawnBlob(map, "wooden_door", offset, 0, true);
				break;
			case map_colors::wooden_door_v_blue:
				autotile(offset);
				spawnBlob(map, "wooden_door", offset, 0, true, Vec2f_zero, 90);
				break;
			case map_colors::wooden_door_h_red:
				autotile(offset);
				spawnBlob(map, "wooden_door", offset, 1, true);
				break;
			case map_colors::wooden_door_v_red:
				autotile(offset);
				spawnBlob(map, "wooden_door", offset, 1, true, Vec2f_zero, 90);
				break;
			case map_colors::wooden_door_h_noteam:
				autotile(offset);
				spawnBlob(map, "wooden_door", offset, 255, true);
				break;
			case map_colors::wooden_door_v_noteam:
				autotile(offset);
				spawnBlob(map, "wooden_door", offset, 255, true, Vec2f_zero, 90);
				break;
			case map_colors::stone_door_h_blue:
				autotile(offset);
				spawnBlob(map, "stone_door", offset, 0, true);
				break;
			case map_colors::stone_door_v_blue:
				autotile(offset);
				spawnBlob(map, "stone_door", offset, 0, true, Vec2f_zero, 90);
				break;
			case map_colors::stone_door_h_red:
				autotile(offset);
				spawnBlob(map, "stone_door", offset, 1, true);
				break;
			case map_colors::stone_door_v_red:
				autotile(offset);
				spawnBlob(map, "stone_door", offset, 1, true, Vec2f_zero, 90);
				break;
			case map_colors::stone_door_h_noteam:
				autotile(offset);
				spawnBlob(map, "stone_door", offset, 255, true);
				break;
			case map_colors::stone_door_v_noteam:
				autotile(offset);
				spawnBlob(map, "stone_door", offset, 255, true, Vec2f_zero, 90);
				break;

			// Trapblocks + bridges
			case map_colors::trapblock_blue:
				autotile(offset);
				spawnBlob(map, "trap_block", offset, 0, true);
				break;
			case map_colors::trapblock_red:
				autotile(offset);
				spawnBlob(map, "trap_block", offset, 1, true);
				break;
			case map_colors::trapblock_noteam:
				autotile(offset);
				spawnBlob(map, "trap_block", offset, 255, true);
				break;

			case map_colors::bridge_blue:
				autotile(offset);
				spawnBlob(map, "bridge", offset, 0, true);
				break;
			case map_colors::bridge_red:
				autotile(offset);
				spawnBlob(map, "bridge", offset, 1, true);
				break;
			case map_colors::bridge_noteam:
				autotile(offset);
				spawnBlob(map, "bridge", offset, 255, true);
				break;
			...
			break;
			case map_colors::lantern:
				autotile(offset);
				spawnBlob(map, "lantern", offset, 255, true);
				break;
			case map_colors::crate:
				autotile(offset);
				spawnBlob(map, "crate", offset);
				break;
			case map_colors::bucket:
				autotile(offset);
				spawnBlob(map, "bucket", offset);
				break;
			case map_colors::sponge:
				autotile(offset);
				spawnBlob(map, "sponge", offset);
				break;
			case map_colors::alpha_chest:
			case map_colors::chest:
				autotile(offset);
				spawnBlob(map, "chest", offset);
				break;

			// Food
			case map_colors::steak:
				autotile(offset);
				spawnBlob(map, "steak", offset);
				break;
			case map_colors::burger:
				autotile(offset);
				spawnBlob(map, "food", offset);
				break;
			case map_colors::heart:
				autotile(offset);
				spawnBlob(map, "heart", offset);
				break;

			// Ground siege
			case map_colors::catapult:
				autotile(offset);
				spawnVehicle(map, "catapult", offset, 0);
				break; // challenge HACK
			case map_colors::ballista:
				autotile(offset);
				spawnVehicle(map, "ballista", offset);
				break;
			case map_colors::mountedbow:
				autotile(offset);
				spawnBlob(map, "mounted_bow", offset, 255, true, Vec2f(0.0f, 4.0f));
				break;

			// Water/air vehicles
			case map_colors::longboat:
				autotile(offset);
				spawnVehicle(map, "longboat", offset);
				break;
			case map_colors::warboat:
				autotile(offset);
				spawnVehicle(map, "warboat", offset);
				break;
			case map_colors::dinghy:
				autotile(offset);
				spawnVehicle(map, "dinghy", offset);
				break;
			case map_colors::raft:
				autotile(offset);
				spawnVehicle(map, "raft", offset);
				break;
			case map_colors::airship:
				autotile(offset);
				spawnVehicle(map, "airship", offset);
				break;
			case map_colors::bomber:
				autotile(offset);
				spawnVehicle(map, "bomber", offset);
				break;

			// Ammo & explosives
			case map_colors::bombs:
				autotile(offset);
				AddMarker(map, offset, "mat_bombs");
				break;
			case map_colors::waterbombs:
				autotile(offset);
				spawnBlob(map, "mat_waterbombs", offset);
				break;
			case map_colors::arrows:
				autotile(offset);
				spawnBlob(map, "mat_arrows", offset);
				break;
			case map_colors::bombarrows:
				autotile(offset);
				spawnBlob(map, "mat_bombarrows", offset);
				break;
			case map_colors::waterarrows:
				autotile(offset);
				spawnBlob(map, "mat_waterarrows", offset);
				break;
			case map_colors::firearrows:
				autotile(offset);
				spawnBlob(map, "mat_firearrows", offset);
				break;
			case map_colors::bolts:
				autotile(offset);
				spawnBlob(map, "mat_bolts", offset);
				break;

			case map_colors::blue_mine:
				autotile(offset);
				spawnBlob(map, "mine", offset, 0);
				break;
			case map_colors::red_mine:
				autotile(offset);
				spawnBlob(map, "mine", offset, 1);
				break;
			case map_colors::mine_noteam:
				autotile(offset);
				spawnBlob(map, "mine", offset);
				break;
			case map_colors::boulder:
				autotile(offset);
				spawnBlob(map, "boulder", offset, -1, false, Vec2f(8.0f, -8.0f));
				break;
			case map_colors::satchel:
				autotile(offset);
				spawnBlob(map, "satchel", offset);
				break;
			case map_colors::keg:
				autotile(offset);
				spawnBlob(map, "keg", offset);
				break;

			// Materials
			case map_colors::gold:
				autotile(offset);
				spawnBlob(map, "mat_gold", offset);
				break;
			case map_colors::stone:
				autotile(offset);
				spawnBlob(map, "mat_stone", offset);
				break;
			case map_colors::wood:
				autotile(offset);
				spawnBlob(map, "mat_wood", offset);
				break;

			// Mooks
			case map_colors::mook_knight:
				autotile(offset);
				AddMarker(map, offset, "mook knight");
				break;
			case map_colors::mook_archer:
				autotile(offset);
				AddMarker(map, offset, "mook archer");
				break;
			case map_colors::mook_spawner:
				autotile(offset);
				AddMarker(map, offset, "mook spawner");
				break;
			case map_colors::mook_spawner_10:
				autotile(offset);
				AddMarker(map, offset, "mook spawner 10");
				break;
			case map_colors::dummy:
				autotile(offset);
...
CBlob @spawnVehicle(CMap @map, const string& in name, int offset, int team = -1)
{
	...
	if (blob !is null)
	{
		...
		if (name == "elevator")
			blob.Tag("invincible"); // (matches your old behavior)
	}
	return blob;
}
