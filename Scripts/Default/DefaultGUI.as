...
void LoadDefaultGUI()
{
    if (v_driver > 0)
    {
		...
		AddIconToken( "$mounted_cannon$", "../Entities/Items/MountedCannon/MCnIcon.png", Vec2f(16,16), 0 );
                AddIconToken( "$mat_crossbolts$", "../Entities/Resources/Icons/CrossboltIcon.png", Vec2f(16,16), 0 );
                AddIconToken( "$mat_rarrows$", "../Entities/Resources/Icons/rArrowIcon.png", Vec2f(16,16), 0 );
                AddIconToken( "$mat_rockets$", "../Entities/Resources/Icons/rocketicon.png", Vec2f(16,16), 0 );
                AddIconToken( "$mat_cannonballs$", "../Entities/Resources/Icons/cannonballicon.png", Vec2f(16,16), 0 );
                AddIconToken( "$mat_orbs$", "../Entities/Resources/Icons/Orbs_mat.png", Vec2f(16,16), 12 );
                AddIconToken( "$mat_fireorbs$", "../Entities/Resources/Icons/Orbs_mat.png", Vec2f(16,16), 13 );
                AddIconToken( "$mat_bomborbs$", "../Entities/Resources/Icons/Orbs_mat.png", Vec2f(16,16), 14 );
                AddIconToken( "$mat_waterorbs$", "../Entities/Resources/Icons/Orbs_mat.png", Vec2f(16,16), 15 );
