...
void LoadDefaultGUI()
{
    if (v_driver > 0)
    {
		...
		AddIconToken( "$triangle$", "../Entities/Buildings/Triangle/Triangle.png", Vec2f(8,8), 0 );
                AddIconToken( "$scrollcarnage$", "../Entities/Items/Scrolls/ScrollCarnage.png", Vec2f(16,16), 0 );
                AddIconToken( "$scrollmidas$", "../Entities/Items/Scrolls/ScrollOfMidas.png", Vec2f(16,16), 0 );
                AddIconToken( "$scrollreinforce$", "../Entities/Items/Scrolls/ScrollReinforce.png", Vec2f(16,16), 0 );
		AddIconToken( "$whitebook$", "../Entities/Items/Scrolls/WhiteBook.png", Vec2f(16,16), 0 );
           AddIconToken( "$soulshard$", "../Entities/Items/Scrolls/WhiteBook/SoulShardIcon.png", Vec2f(16,16), 0 );
                AddIconToken( "$scrollslayer$", "../Entities/Items/Scrolls/ScrollSlayer.png", Vec2f(16,16), 0 );
                AddIconToken( "$scrollnecromancer$", "../Entities/Items/Scrolls/ScrollNecromancer.png", Vec2f(16,16), 0 );
                AddIconToken( "$scrollgargoyle$", "../Entities/Items/Scrolls/ScrollGargoyle.png", Vec2f(16,16), 0 );
                AddIconToken( "$scrollbunny$", "../Entities/Items/Scrolls/ScrollBunny.png", Vec2f(16,16), 0 );
                AddIconToken( "$scrolldrought$", "../Entities/Items/Scrolls/ScrollDrought.png", Vec2f(16,16), 0 );
                AddIconToken( "$scrollreturn$", "../Entities/Items/Scrolls/ScrollReturn.png", Vec2f(16,16), 0 );
                AddIconToken( "$scrollzombie$", "../Entities/Items/Scrolls/ScrollZombie.png", Vec2f(16,16), 0 );
                AddIconToken( "$scrollskeleton$", "../Entities/Items/Scrolls/ScrollSkeleton.png", Vec2f(16,16), 0 );
                AddIconToken( "$scrollmeteor$", "../Entities/Items/Scrolls/ScrollMeteor.png", Vec2f(16,16), 0 );
                AddIconToken( "$scrollchicken$", "../Entities/Items/Scrolls/ScrollChicken.png", Vec2f(16,16), 0 );
            AddIconToken( "$scrollburd$", "../Entities/Items/Scrolls/ScrollBurd.png", Vec2f(16,16), 0 );
            AddIconToken( "$scrollarsonist$", "../Entities/Items/Scrolls/ScrollPyro.png", Vec2f(16,16), 0 );
            AddIconToken( "$scrollcrossbow$", "../Entities/Items/Scrolls/ScrollCrossbow.png", Vec2f(16,16), 0 );
            AddIconToken( "$scrollassassin$", "../Entities/Items/Scrolls/ScrollAssassin.png", Vec2f(16,16), 0 );
            AddIconToken( "$scrollnecro$", "../Entities/Items/Scrolls/ScrollNecro.png", Vec2f(16,16), 0 );
		...
		AddIconToken( "$archerbot$", "../Entities/NPCs/Archerbot/ArcherBotIcon.png", Vec2f(16,16), 0 );
