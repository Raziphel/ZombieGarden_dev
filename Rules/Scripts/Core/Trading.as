...
// i have no idea what was going on this script so i copied and pasted vanilla
...
void awardCoins(CBitStream @params)
{
	...
	u8 event_id;
	if (!params.saferead_u8(event_id))
		return;

	u16 player_id;
	if (!params.saferead_u16(player_id))
		return;
