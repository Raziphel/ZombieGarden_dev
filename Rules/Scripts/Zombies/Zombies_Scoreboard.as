...
void onBlobDie(CRules @ this, CBlob @blob)
{
	...
	if (this.isGameOver() || this.isWarmup() || blob is null)
		return;

	CPlayer @killer =
		blob.getPlayerOfRecentDamage(); // player who dealt the most recent damage
	CPlayer @victim =
		blob.getPlayer();				// player who died (may be null for zombies etc.)
	...
	if (killer is null)
		return; // environment death or no killer -> nothing to do
