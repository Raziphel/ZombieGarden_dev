	...
	if (XORRandom(20) == 0)
	{
		...
		else if (tilebelow == CMap::tile_ground + 7 || tilebelow == CMap::tile_ground + 8) // grassy ground below
		{
			...
			switch (tileatpos)
			{
				...
				{
					map.server_SetTile(tilepos, CMap::tile_grass_fullbackground1_d3 + XORRandom(2));
					break;
				}
				...
				{
					map.server_SetTile(tilepos, CMap::tile_grass_fullbackground1_d2 + XORRandom(2));
					break;
				}
				...
				{
					map.server_SetTile(tilepos, CMap::tile_grass_fullbackground1_d1 + XORRandom(2));
					break;
				}
				...
				{
					map.server_SetTile(tilepos, CMap::tile_grass_fullbackground1 + XORRandom(2));
					break;
				}

				case CMap::tile_empty:
				{
					map.server_SetTile(tilepos, CMap::tile_grass + 3);
					break;
				}
				case CMap::tile_grass + 3:
				{
					map.server_SetTile(tilepos, CMap::tile_grass + 2);
					break;
				}
				case CMap::tile_grass + 2:
				{
					map.server_SetTile(tilepos, CMap::tile_grass + 1);
					break;
				}
				case CMap::tile_grass + 1:
				{
					map.server_SetTile(tilepos, CMap::tile_grass);
					break;
				}
			}
