...
bool doesCollideWithBlob(CBlob @ this, CBlob @b)
{
	if (b.hasTag("blocks water"))
	{
		return true;
			...
			isEnemy(this, b) || b.hasTag("door") || b.hasTag("survivormechanism") || (b.getPlayer() !is null && this.getDamageOwnerPlayer() !is null && b.getPlayer() is this.getDamageOwnerPlayer() || b.getName() == this.getName()));
}
