...
const f32 ARROW_PUSH_FORCE = 8.0f;
const f32 SPECIAL_HIT_SCALE = 0.5f;
...
void onCollision(CBlob @ this, CBlob @blob, bool solid, Vec2f normal, Vec2f point1)
{
	if (blob !is null && doesCollideWithBlob(this, blob) && !this.hasTag("collided"))
	{
		...
		if (blob.getName() != "log" && blob.getName() != "tree_bushy" && blob.getName() != "tree_pine")
		{ // dont stick bomb arrows
			this.Tag("collided");
		}
