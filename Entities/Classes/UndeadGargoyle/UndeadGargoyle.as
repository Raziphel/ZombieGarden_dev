...
void onInit(CBlob @ this)
{
	...
	AddIconToken("$Grab$", "Entities/Shared/GUI/HelpIcons.png", Vec2f(16, 16), 5);
	AddIconToken("$Release$", "Entities/Shared/GUI/HelpIcons.png", Vec2f(16, 16), 4);
...
void MadAt(CBlob @ this, CBlob @hitterBlob)
{
	const u16 damageOwnerId = (hitterBlob.getDamageOwnerPlayer() !is null && hitterBlob.getDamageOwnerPlayer().getBlob() !is null) ?
								  hitterBlob.getDamageOwnerPlayer().getBlob().getNetworkID() :
								  0;
