...
void ManageCursors(CBlob @ this)
{
	...
	{
		// set cursor
		getHUD().SetCursorImage("Entities/Classes/Priest/PriestCursor.png", Vec2f(32, 32));
...
void onRender(CSprite @ this)
{
	...
	else
	{
		...
		GUI::SetFont("menu");
		GUI::DrawText("" + cooldownTeleportSecs, Vec2f(30, 123), SColor(255, 255, 216, 0));
	}
	// orb icons
	...
	if (cooldownOrbFullSecs == 0 && cooldownOrbSecs >= 0)
		cooldownOrbSecsHUD = cooldownOrbSecs;
	...
	if (count == ORB_LIMIT)
	{
		GUI::DrawIcon("MenuItems.png", 13, Vec2f(32, 32), Vec2f(10, 58), 0.5f);
		GUI::SetFont("menu");
		GUI::DrawText("" + cooldownOrbSecs, Vec2f(30, 75), SColor(255, 255, 216, 0));
	}
	else
	{
		GUI::DrawIcon("prSpellIcons.png", 2, Vec2f(16, 16), Vec2f(10, 58), 1.0f, 1);
		GUI::SetFont("menu");
		GUI::DrawText("" + orbsCount, Vec2f(30, 75), SColor(255, 255, 216, 0));
	}
